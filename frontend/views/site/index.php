	...
	<div class="row">
		<div class="container">
			...
			<div class="col-lg-6 " style="text-align:center">
				...
				<img src="image/photo.jpg" class="img-circle img-thumbnail" height=400px style="height:300px">
				<hr>
			</div>
			<div class="col-lg-6">
				<h3><i class="fa fa-industry"  aria-hidden="true"></i>Nước sạch công nghiệp, dịch vụ</h3>
				<img src="image/factory-512.png"  class="img-circle img-thumbnail" height=400px style="height:300px">
				<hr>
			</div>
