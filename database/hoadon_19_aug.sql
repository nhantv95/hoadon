...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 18, 2016 at 08:44 PM
...
(2, 2, '2016-07-02', 299, 6, 2016, 'đã nộp'),
(2, 2, '2016-06-02', 204, 5, 2016, 'đã nộp'),
(2, 2, '2016-01-02', 200, 12, 2015, 'đã nộp'),
(2, 2, '2016-02-02', 215, 1, 2016, 'đã nộp'),
(2, 2, '2016-03-02', 230, 2, 2016, 'đã nộp'),
(2, 2, '2016-04-02', 199, 3, 2016, 'đã nộp');
...
`maHopDong` int(11) NOT NULL,
  `maKhachHang` int(11) NOT NULL,
  `nguoiNhapID` int(11) NOT NULL,
  `ngayKi` date NOT NULL,
  `ngayHetHan` date NOT NULL,
  `loaiHopDong` varchar(50) COLLATE utf8_unicode_ci NOT NULL
...
INSERT INTO `hopdong` (`maHopDong`, `maKhachHang`, `nguoiNhapID`, `ngayKi`, `ngayHetHan`, `loaiHopDong`) VALUES
(1, 2, 3, '2015-12-01', '0000-00-00', 'Nước Sinh Hoạt');
...
(2, 'Thông báo thu tiền nước', 2, '2016-08-03'),
(3, 'Tin Tức', 2, '2016-08-18');
...
(9, 'Thu tiền nước tháng 7/2016', 'image/catnuoc.jpg', 'Công ty TNHH MTV nước sạch Hà Đông bắt đầu thu tiền nước sinh hoạt từ ngày 2/8/2016 đến 5/8/2016 tại UBND các phường.<br>Các doanh nghiệp chuyển khoảng cho công ty trước ngày 6/8/2016', 'Thi tiền nước từ ngày 2/8/2016', 2, '2016-08-16', 2),
(10, 'Hà Nội tăng giá nước sạch 19% từ ngày 1-10-2015', 'image/catnuoc.jpg', 'Ngày 27-9, trao đổi với Tuổi Trẻ, ông Lê Hồng Quân, prưởng phòng hạ tầng cấp thoát nước (Sở Xây dựng Hà Nội) cho biết như trên.<br><br>\r\nTheo ông Quân, việc tăng giá nước sạch được thực hiện theo lộ trình đã được thành phố phê duyệt từ năm 2013.<br><br>\r\nTháng 9-2013 trên cơ sở đề nghị của liên ngành, TP Hà Nội đã ban hành quyết định điều chỉnh giá bán nước sạch, trong đó xác định lộ trình ngày 1-10-2015 sẽ điều chỉnh tăng giá bán nước sạch theo khung đã được phê duyệt từ năm 2013. Như vậy, lần điều chỉnh giá bán nước sạch kỳ này là có sự chuẩn bị, có lộ trình và cả các đơn vị kinh doanh nước sạch lẫn người sử dụng nước sạch đều có sự chuẩn bị, không bất ngờ” - ông Quân cho hay.<br><br>\r\nTheo Công ty Nước sạch Hà Nội, giá bán nước sạch sinh hoạt theo cách tính lũy tiến sẽ tăng từ 5.020 đồng/m3 lên 5.973 đồng/m3 với 10m3 đầu tiên.<br><br>\r\n“Theo giá bán nước sạch đang áp dụng thì một hộ dân sử dụng nước thất nhất khoảng 10m3/tháng sẽ phải chi trả 50.200 đồng/tháng. Nhưng từ 1-10 tới thì một hộ dân sử dụng nước thấp nhất khoảng 10m3/tháng phải chi trả 59.730 đồng/tháng. Số tiền phải trả thêm là 9.530 đồng/tháng.<br><br>\r\nTương tự, nếu hộ dân sử dụng khoảng 15m3/tháng thì số tiền hiện phải trả khoảng 79.850 đồng/tháng, còn theo giá nước sạch từ 1-10 phải trả 94.990 đồng/tháng. Như vậy, số tiền chênh lệch với hộ sử dụng nước sinh hoạt bình quân khoảng 15m3/tháng phải trả thêm 15.140 đồng/tháng. Đây là mức tăng mà người dân có thể chấp nhận được” - một lãnh đạo Công ty Nước sạch Hà Nội nói.<br<br>\r\nTương tự, giá bán nước sạch cho các cơ quan, đơn vị phục vụ sản xuất, kinh doanh cũng đã được điều chỉnh tăng 19% so với mức giá hiện đang áp dụng', '', 2, '2016-08-17', 3);
...
--
ALTER TABLE `hopdong`
MODIFY `maHopDong` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
